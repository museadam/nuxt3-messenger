globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import Rt, { Server as Server$2 } from 'node:http';
import Ka, { Server as Server$1 } from 'node:https';
...
import { statSync, promises, createReadStream, existsSync as existsSync$1 } from 'node:fs';
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/adam/projects/nuxt3-messenger/.data/kv"}));
...
const assets = {
  "/favicon.ico": {
    ...
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 4286,
    "path": "../public/favicon.ico"
  },
  "/_nuxt/auth.4ed993c7.js": {
    "type": "application/javascript",
    "etag": "\"1-rcg7GeeTSRscbqD9i0bNnzLlkvw\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 1,
    "path": "../public/_nuxt/auth.4ed993c7.js"
  },
  "/_nuxt/default.3fc3f506.js": {
    "type": "application/javascript",
    "etag": "\"ad0-P2fPjX7N0zXiYNrOPdnpvv6JawE\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 2768,
    "path": "../public/_nuxt/default.3fc3f506.js"
  },
  "/_nuxt/default.ee3154a9.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"18-JvEA/Y5LCm4ybmklVFyE2HwG9wM\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 24,
    "path": "../public/_nuxt/default.ee3154a9.css"
  },
  "/_nuxt/entry.9c543a45.js": {
    "type": "application/javascript",
    "etag": "\"237a5-972ULE93/eE1lOUAIEbmqRKI/ig\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 145317,
    "path": "../public/_nuxt/entry.9c543a45.js"
  },
  "/_nuxt/entry.d3622e68.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"1619-b5PPXny85kwzQ2z/WexD9T43f7Q\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 5657,
    "path": "../public/_nuxt/entry.d3622e68.css"
  },
  "/_nuxt/error-404.1d3101b0.js": {
    "type": "application/javascript",
    "etag": "\"188a-sYSmjLkYe87DjOlnkRs3S8WD31o\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 6282,
    "path": "../public/_nuxt/error-404.1d3101b0.js"
  },
  ...
  "/_nuxt/error-500.4c130e73.js": {
    "type": "application/javascript",
    "etag": "\"77e-HZRIZ3MbC+JWuSsqqETiq5+eYds\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 1918,
    "path": "../public/_nuxt/error-500.4c130e73.js"
  },
  ...
  "/_nuxt/index.96d0578c.js": {
    "type": "application/javascript",
    "etag": "\"75f-ac/U8kEpQF95EveJfNNAIzYP7GY\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 1887,
    "path": "../public/_nuxt/index.96d0578c.js"
  },
  "/_nuxt/index.9e3ce889.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"54-RfLrXcxN/yvd3glHm6o6R+Su7V8\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 84,
    "path": "../public/_nuxt/index.9e3ce889.css"
  },
  "/_nuxt/index.f2626643.js": {
    "type": "application/javascript",
    "etag": "\"bab-FI+ys9kAUS4zHuS+p8BrbTGUgr8\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 2987,
    "path": "../public/_nuxt/index.f2626643.js"
  },
  "/_nuxt/store.0eda8526.js": {
    "type": "application/javascript",
    "etag": "\"5d-CnNMtit7XG2wD96bcoRjs48RR6I\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 93,
    "path": "../public/_nuxt/store.0eda8526.js"
  },
  "/_nuxt/vue.f36acd1f.bfe4e63b.js": {
    "type": "application/javascript",
    "etag": "\"186-vodldLiUxBSxvQMyaMKnSGcywu8\"",
    "mtime": "2023-10-06T23:44:27.781Z",
    "size": 390,
    "path": "../public/_nuxt/vue.f36acd1f.bfe4e63b.js"
  }
};
...
const _D3NsJS = defineEventHandler((event) => {
});

const _6206NP = defineEventHandler((event) => {
  console.log("New request: " + event.req.url);
});

function createIOHandler(functions, serverOptions) {
  return eventHandler((event) => {
    if (!globalThis.__io && true) {
...
async function resolvePath(path, opts = {}) {
  const _path = path;
  path = normalize(path);
  if (isAbsolute(path) && existsSync$1(path) && !await isDirectory(path)) {
    return path;
  }
  ...
  for (const ext of extensions) {
    ...
    if (existsSync$1(pathWithExt)) {
      return pathWithExt;
    }
    const pathWithIndex = join(path, "index" + ext);
    if (_isDir && existsSync$1(pathWithIndex)) {
...
defineNuxtModule({
  ...
  async setup(options, nuxt) {
    const { resolve } = createResolver(globalThis._importMeta_.url);
    const extGlob = "**/*.{ts,js,mjs}";
    const files = [];
    const runtimeDir = fileURLToPath$1(new URL("./runtime", globalThis._importMeta_.url));
    ...
    addTemplate({
      ...
      getContents() {
        return `
          ...
          ${files.map(
          (file, index) => `const function${index} = _require('${file.replace(
            ".ts",
            ""
          )}');`
        ).join("\n")}
    ...
    addTemplate({
      ...
      getContents() {
        return `
          ...
          ${files.map(
          (file, index) => `import function${index} from '${file.replace(".ts", "")}'`
        ).join("\n")}
...
class roomUsers {
  ...
  removeUser(id) {
    ...
    if (user) {
      this.users = this.users.filter((user2) => user2.id !== id);
    }
    return user;
  }
  // removeUserSlug(slug) {
...
const function0 = defineIOHandler((io) => {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("disconnecting", () => {
      console.log("disconnecting... your rooms: " + socket.rooms);
    });
...
const _RuMbPT = createIOHandler({
  function0
}, {});

const _lazy_RJ4cYZ = () => import('../login-post.mjs');
const _lazy_5ludQI = () => import('../app/_nuxt/auth-4ed993c7.mjs').then(function (n) { return n.s; });
const _lazy_FiOrMi = () => import('../sign-up.post.mjs');
const _lazy_n2aPnd = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '', handler: _f4b49z, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _D3NsJS, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _6206NP, lazy: false, middleware: true, method: undefined },
  { route: '/api/v1/users/login-post', handler: _lazy_RJ4cYZ, lazy: true, middleware: false, method: undefined },
  { route: '/api/v1/users/send-auth', handler: _lazy_5ludQI, lazy: true, middleware: false, method: undefined },
  { route: '/api/v1/users/sign-up', handler: _lazy_FiOrMi, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_n2aPnd, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _RuMbPT, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_n2aPnd, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, getRouteRules as A, getResponseStatusText as B, nodeServer as C, defineEventHandler as a, withQuery as b, createError$1 as c, dr as d, createHooks as e, defu as f, getContext as g, hasProtocol as h, isScriptProtocol as i, joinURL as j, parseQuery as k, withTrailingSlash as l, withoutTrailingSlash as m, eventHandler as n, setResponseHeader as o, parseURL as p, send as q, readBody as r, sanitizeStatusCode as s, getResponseStatus as t, useRuntimeConfig as u, setResponseStatus as v, wn as w, setResponseHeaders as x, useNitroApp as y, getQuery as z };
